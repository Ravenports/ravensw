...
package Core.Repo is
   ...
   function repo_init   (this : Base_Repo_Operations; repo : T_pkg_repo)
                         return Boolean is abstract;
   function repo_create (this : Base_Repo_Operations; repo : T_pkg_repo)
                         return Boolean is abstract;
   ...
   function repo_open   (this : Base_Repo_Operations; repo : T_pkg_repo; mode : mode_t)
                         return Boolean is abstract;
   function repo_access (this : Base_Repo_Operations; repo : T_pkg_repo; mode : mode_t)
                         return Boolean is abstract;

   --  TODO: add flags to repo_ensure loaded
   function repo_ensure_loaded (this : Base_Repo_Operations; repo : T_pkg_repo; pkg1 : T_pkg)
                                return Boolean is abstract;
